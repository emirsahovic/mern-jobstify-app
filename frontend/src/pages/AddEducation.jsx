    ...
    return (
        <div className='h-full'>
            <div className='mx-auto pt-14 xs:max-w-sm md:max-w-3xl lg:max-w-5xl xl:max-w-6xl'>
                <BackButton />
                <h1 className="text-center text-3xl pb-3">Add An Education</h1>
                ...
                <form className='flex flex-col space-y-4 mt-2' onSubmit={e => onSubmit(e)}>
                    <div className='flex flex-col'>
                        <input type="text" required className='border-gray-300 border-2 focus:outline-none rounded-lg w-full p-2.5' placeholder="* School" name="school" value={school} onChange={(e) => onChange(e)} />
                    </div>
                    <div className='flex flex-col'>
                        <input type="text" required className='border-gray-300 border-2 focus:outline-none rounded-lg w-full p-2.5' placeholder="* Degree" name="degree" value={degree} onChange={(e) => onChange(e)} />
                    </div>
                    <div className='flex flex-col'>
                        <input type="text" required className='border-gray-300 border-2 focus:outline-none rounded-lg w-full p-2.5' placeholder="* Field of study" name="fieldofstudy" value={fieldofstudy} onChange={(e) => onChange(e)} />
                    </div>
                    <div className='flex flex-col'>
                    ...
                    <div className='flex flex-col'>
                        <textarea placeholder="Short Description" rows={3} className='border-gray-300 border-2 focus:outline-none rounded-lg w-full p-2.5' name="description" value={description} onChange={(e) => onChange(e)}></textarea>
                    </div>
