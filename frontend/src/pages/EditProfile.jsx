        ...
        <div className='h-full'>
            <div className='mx-auto pt-14 xs:max-w-sm md:max-w-3xl lg:max-w-5xl xl:max-w-6xl'>
                ...
                <form className='flex flex-col space-y-4 mt-2' onSubmit={e => onSubmit(e)}>
                    ...
                    <div className='flex flex-col'>
                        <textarea rows={4} placeholder="Say something about yourself... " className='border-gray-300 border-2 focus:outline-none rounded-lg w-full p-2.5' name="bio" value={bio || ''} onChange={(e) => onChange(e)}></textarea>
                    </div>
                    ...
                    <div className='pb-14 pt-4'>
                        <button type='submit' className='bg-green-500 py-2 mx-auto block px-10 rounded text-white font-bold hover:opacity-80 transition duration-200'>Save Changes</button>
                    </div>
                </form>
            </div>
        </div>
